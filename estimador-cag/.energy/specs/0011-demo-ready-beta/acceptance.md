# Spec 0011 acceptance

No item is accepted without direct evidence.

- [x] Hard failures cannot be outvoted.
- [x] Judges and meta-judge cannot authorize execution.
- [x] Independent jury disagreement is inspectable.
