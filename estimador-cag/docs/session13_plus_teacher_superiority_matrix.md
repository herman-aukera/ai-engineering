...
| Agent loop | Provider-neutral typed tools with iteration, call, time, cost and size budgets | `test_session13_plus_agent_tool_runtime.py` | Credentialed DeepSeek and Kimi turns completed in run `29526996872` | The live gate is bounded connectivity evidence, not a quality ranking |
