...
def build_ledger_integrity(ledger_path: Path) -> dict[str, Any]:
    ...
    for line_number, line in enumerate(raw_lines, start=1):
        ...
        try:
            ...
            valid_records.append(EnergyDecision.model_validate(payload))
    ...
    return {
        ...
        "ledger_path": str(path),
        "exists": True,
        "complete": invalid_total == 0 and not energy_delta_mismatches,
